        ...
        <div className="grid grid-cols-8">
          ...
          <div className="border-r border-neutral-200">
            {Array.from({ length: 16 }, (_, i) => i + 9).map((hour) => (
              <div key={hour} className="h-16 p-2 text-xs text-neutral-500 border-b border-neutral-200">
          ...
          {weekDays.map((day) => {
            ...
            return (
              <div key={day.toString()} className="min-w-[120px]">
                {Array.from({ length: 16 }, (_, i) => i + 9).map((hour) => {
                  const timeSlotAppointments = dayAppointments.filter(
